...
OUT_DIR="$HARNESS_DIR/skills/ts-lint-format-audit"
...
pooh_runtime_update "running" "" "Running TypeScript lint / format audit."

python3 "$SCRIPT_DIR/run_ts_lint_format_scan.py" \
  --repo "$REPO_ROOT" \
...
python3 "$SCRIPT_DIR/validate_ts_lint_format_summary.py" \
  --summary "$SUMMARY_PATH"

pooh_runtime_finalize

echo "TypeScript lint / format audit complete."
