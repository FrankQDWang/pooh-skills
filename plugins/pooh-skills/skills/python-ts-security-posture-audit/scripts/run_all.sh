...
OUT_DIR="$HARNESS_DIR/skills/python-ts-security-posture-audit"
...
pooh_runtime_update "running" "" "Running Python / TS security posture audit."

python3 "$SCRIPT_DIR/run_python_ts_security_posture_scan.py" \
  --repo "$REPO_ROOT" \
...
python3 "$SCRIPT_DIR/validate_security_posture_summary.py" \
  --summary "$SUMMARY_PATH"

pooh_runtime_finalize

echo "Python / TS security posture audit complete."
