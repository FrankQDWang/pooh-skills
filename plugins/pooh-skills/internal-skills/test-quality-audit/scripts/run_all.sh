...
OUT_DIR="$HARNESS_DIR/skills/test-quality-audit"
...
pooh_runtime_update "running" "" "Running test quality audit."

python3 "$SCRIPT_DIR/run_test_quality_scan.py" \
  --repo "$REPO_ROOT" \
...
python3 "$SCRIPT_DIR/validate_test_quality_summary.py" --summary "$SUMMARY_PATH"

pooh_runtime_finalize

echo "Test quality audit complete."
