#!/usr/bin/env python3
"""Validate secrets-and-hardcode-audit summary JSON."""
...
def main() -> int:
    if len(sys.argv) != 3 or sys.argv[1] != "--summary":
        return fail("usage: validate_secrets_and_hardcode_summary.py --summary /path/to/summary.json")
    ...
    if data.get("skill") != "secrets-and-hardcode-audit":
        return fail("skill must be `secrets-and-hardcode-audit`")
