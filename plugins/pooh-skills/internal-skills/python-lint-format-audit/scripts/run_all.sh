...
OUT_DIR="$HARNESS_DIR/skills/python-lint-format-audit"
...
pooh_runtime_update "running" "" "Running Python lint / format audit."

python3 "$SCRIPT_DIR/run_python_lint_format_scan.py" \
  --repo "$REPO_ROOT" \
...
python3 "$SCRIPT_DIR/validate_python_lint_format_summary.py" \
  --summary "$SUMMARY_PATH"

pooh_runtime_finalize

echo "Python lint / format audit complete."
