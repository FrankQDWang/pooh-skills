...
SUMMARY_PATH="$OUT_DIR/overdefensive-silent-failure-summary.json"
REPORT_PATH="$OUT_DIR/overdefensive-silent-failure-report.md"
AGENT_BRIEF_PATH="$OUT_DIR/overdefensive-silent-failure-agent-brief.md"
