...
- spawn all 10 child subagents in parallel
...
6. During the run, confirm the terminal redraw shows all 10 worker cards and does not collapse into snapshot logging.
...
- 10 current-run child namespaces under `.repo-harness/skills/`
