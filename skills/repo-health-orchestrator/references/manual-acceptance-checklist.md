...
1. Start from the target repo root without trusting any existing `.repo-harness`.
...
- 17 current-run child namespaces under `.repo-harness/skills/`
- 6 repo-level orchestrator artifacts at the target repo's `.repo-harness/`
