...
OUT_DIR="$HARNESS_DIR/skills/secrets-and-hardcode-audit"
...
pooh_runtime_update "running" "" "Running secrets and hardcode audit."

python3 "$SCRIPT_DIR/run_secrets_and_hardcode_scan.py" \
  --repo "$REPO_ROOT" \
...
python3 "$SCRIPT_DIR/validate_secrets_and_hardcode_summary.py" \
  --summary "$SUMMARY_PATH"

pooh_runtime_finalize

echo "Secrets and hardcode audit complete."
